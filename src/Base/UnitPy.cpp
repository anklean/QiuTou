...
PyObject * UnitPy::staticCallback_getType (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((UnitPy*)self)->getType());
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject UnitPy::Parents[] = { PARENTSBaseUnitPy };
...
UnitPy::~UnitPy()                                // Everything handled in parent
{
    ...
    UnitPy::PointerType ptr = reinterpret_cast<UnitPy::PointerType>(_pcTwinPointer);
    delete ptr;
}
