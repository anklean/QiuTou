...
PyObject * AxisPy::staticCallback_copy (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((AxisPy*)self)->copy(args);
        if (ret != 0)
            ((AxisPy*)self)->startNotify();
        return ret;
    }
...
PyObject * AxisPy::staticCallback_move (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((AxisPy*)self)->move(args);
        if (ret != 0)
            ((AxisPy*)self)->startNotify();
        return ret;
    }
...
PyObject * AxisPy::staticCallback_multiply (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((AxisPy*)self)->multiply(args);
        if (ret != 0)
            ((AxisPy*)self)->startNotify();
        return ret;
    }
...
PyObject * AxisPy::staticCallback_reversed (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((AxisPy*)self)->reversed(args);
        if (ret != 0)
            ((AxisPy*)self)->startNotify();
        return ret;
    }
...
PyObject * AxisPy::staticCallback_getBase (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((AxisPy*)self)->getBase());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((AxisPy*)self)->setBase(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * AxisPy::staticCallback_getDirection (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((AxisPy*)self)->getDirection());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((AxisPy*)self)->setDirection(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject AxisPy::Parents[] = { PARENTSBaseAxisPy };
