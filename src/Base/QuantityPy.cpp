...
PyObject * QuantityPy::staticCallback_getUserPreferred (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((QuantityPy*)self)->getUserPreferred(args);
        return ret;
    }
...
PyObject * QuantityPy::staticCallback_getValueAs (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((QuantityPy*)self)->getValueAs(args);
        return ret;
    }
    catch(const Base::Exception& e) // catch the FreeCAD exceptions
    {
...
PyObject * QuantityPy::staticCallback_getValue (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((QuantityPy*)self)->getValue());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((QuantityPy*)self)->setValue(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * QuantityPy::staticCallback_getUnit (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((QuantityPy*)self)->getUnit());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((QuantityPy*)self)->setUnit(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * QuantityPy::staticCallback_getUserString (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((QuantityPy*)self)->getUserString());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject QuantityPy::Parents[] = { PARENTSBaseQuantityPy };
...
QuantityPy::~QuantityPy()                                // Everything handled in parent
{
    ...
    QuantityPy::PointerType ptr = reinterpret_cast<QuantityPy::PointerType>(_pcTwinPointer);
    delete ptr;
}
