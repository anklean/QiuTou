...
PyObject * RotationPy::staticCallback_invert (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((RotationPy*)self)->invert(args);
        if (ret != 0)
            ((RotationPy*)self)->startNotify();
        return ret;
    }
...
PyObject * RotationPy::staticCallback_multiply (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((RotationPy*)self)->multiply(args);
        return ret;
    }
    catch(const Base::Exception& e) // catch the FreeCAD exceptions
    {
...
PyObject * RotationPy::staticCallback_multVec (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((RotationPy*)self)->multVec(args);
        return ret;
    }
    catch(const Base::Exception& e) // catch the FreeCAD exceptions
    {
...
PyObject * RotationPy::staticCallback_toEuler (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((RotationPy*)self)->toEuler(args);
        return ret;
    }
    catch(const Base::Exception& e) // catch the FreeCAD exceptions
    {
...
PyObject * RotationPy::staticCallback_isNull (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((RotationPy*)self)->isNull(args);
        return ret;
    }
    catch(const Base::Exception& e) // catch the FreeCAD exceptions
    {
...
PyObject * RotationPy::staticCallback_getQ (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((RotationPy*)self)->getQ());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((RotationPy*)self)->setQ(Py::Tuple(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * RotationPy::staticCallback_getAxis (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((RotationPy*)self)->getAxis());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((RotationPy*)self)->setAxis(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * RotationPy::staticCallback_getAngle (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((RotationPy*)self)->getAngle());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((RotationPy*)self)->setAngle(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject RotationPy::Parents[] = { PARENTSBaseRotationPy };
