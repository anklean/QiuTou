...
PyObject * BaseClassPy::staticCallback_isDerivedFrom (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((BaseClassPy*)self)->isDerivedFrom(args);
        return ret;
    }
...
PyObject * BaseClassPy::staticCallback_getAllDerivedFrom (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((BaseClassPy*)self)->getAllDerivedFrom(args);
        return ret;
    }
    catch(const Base::Exception& e) // catch the FreeCAD exceptions
    {
...
PyObject * BaseClassPy::staticCallback_getTypeId (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((BaseClassPy*)self)->getTypeId());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject BaseClassPy::Parents[] = { PARENTSBaseBaseClassPy };
