...
PyObject * PersistencePy::staticCallback_getContent (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((PersistencePy*)self)->getContent());
...
{    
    ...
    try {
        ((PersistencePy*)self)->setContent(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * PersistencePy::staticCallback_getMemSize (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((PersistencePy*)self)->getMemSize());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject PersistencePy::Parents[] = { PARENTSBasePersistencePy };
