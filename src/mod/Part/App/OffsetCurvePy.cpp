...
PyObject * OffsetCurvePy::staticCallback_getOffsetValue (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((OffsetCurvePy*)self)->getOffsetValue());
...
{    
    ...
    try {
        ((OffsetCurvePy*)self)->setOffsetValue(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * OffsetCurvePy::staticCallback_getOffsetDirection (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((OffsetCurvePy*)self)->getOffsetDirection());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((OffsetCurvePy*)self)->setOffsetDirection(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * OffsetCurvePy::staticCallback_getBasisCurve (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((OffsetCurvePy*)self)->getBasisCurve());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((OffsetCurvePy*)self)->setBasisCurve(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject OffsetCurvePy::Parents[] = { PARENTSPartOffsetCurvePy };
