...
PyObject * TopoShapeCompoundPy::staticCallback_add (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TopoShapeCompoundPy*)self)->add(args);
        if (ret != 0)
            ((TopoShapeCompoundPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TopoShapeCompoundPy::staticCallback_connectEdgesToWires (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TopoShapeCompoundPy*)self)->connectEdgesToWires(args);
        return ret;
    }
    catch(const Base::Exception& e) // catch the FreeCAD exceptions
    {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject TopoShapeCompoundPy::Parents[] = { PARENTSPartTopoShapeCompoundPy };
