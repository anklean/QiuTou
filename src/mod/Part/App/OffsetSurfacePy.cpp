...
PyObject * OffsetSurfacePy::staticCallback_uIso (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((OffsetSurfacePy*)self)->uIso(args);
        if (ret != 0)
            ((OffsetSurfacePy*)self)->startNotify();
        return ret;
    }
...
PyObject * OffsetSurfacePy::staticCallback_vIso (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((OffsetSurfacePy*)self)->vIso(args);
        if (ret != 0)
            ((OffsetSurfacePy*)self)->startNotify();
        return ret;
    }
...
PyObject * OffsetSurfacePy::staticCallback_getOffsetValue (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((OffsetSurfacePy*)self)->getOffsetValue());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((OffsetSurfacePy*)self)->setOffsetValue(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * OffsetSurfacePy::staticCallback_getBasisSurface (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((OffsetSurfacePy*)self)->getBasisSurface());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((OffsetSurfacePy*)self)->setBasisSurface(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject OffsetSurfacePy::Parents[] = { PARENTSPartOffsetSurfacePy };
