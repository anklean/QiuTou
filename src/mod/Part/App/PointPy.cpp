...
// This File is normaly build as an include in PointPyImp.cpp! Its not intended to be in a project!
...
PyObject * PointPy::staticCallback_toShape (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((PointPy*)self)->toShape(args);
        return ret;
    }
...
PyObject * PointPy::staticCallback_getX (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((PointPy*)self)->getX());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while reading attribute 'X' of object 'GeomPoint'");
        return NULL;
    }
}
...
{    
    ...
    try {
        ((PointPy*)self)->setX(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while writing attribute 'X' of object 'GeomPoint'");
        return -1;
    }
}
...
PyObject * PointPy::staticCallback_getY (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((PointPy*)self)->getY());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while reading attribute 'Y' of object 'GeomPoint'");
        return NULL;
    }
}
...
{    
    ...
    try {
        ((PointPy*)self)->setY(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while writing attribute 'Y' of object 'GeomPoint'");
        return -1;
    }
}
...
PyObject * PointPy::staticCallback_getZ (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((PointPy*)self)->getZ());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while reading attribute 'Z' of object 'GeomPoint'");
        return NULL;
    }
}
...
{    
    ...
    try {
        ((PointPy*)self)->setZ(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while writing attribute 'Z' of object 'GeomPoint'");
        return -1;
    }
}
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject PointPy::Parents[] = { PARENTSPartPointPy };
...
// PointPy Attributes
//--------------------------------------------------------------------------
PyObject *PointPy::_getattr(char *attr)				// __getattr__ function: note only need to handle new state
{
    try {
...
int PointPy::_setattr(char *attr, PyObject *value) 	// __setattr__ function: note only need to handle new state
{
    try {
