...
PyObject * ArcOfParabolaPy::staticCallback_getFocal (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ArcOfParabolaPy*)self)->getFocal());
...
{    
    ...
    try {
        ((ArcOfParabolaPy*)self)->setFocal(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ArcOfParabolaPy::staticCallback_getAngleXU (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ArcOfParabolaPy*)self)->getAngleXU());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ArcOfParabolaPy*)self)->setAngleXU(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ArcOfParabolaPy::staticCallback_getCenter (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ArcOfParabolaPy*)self)->getCenter());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ArcOfParabolaPy*)self)->setCenter(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ArcOfParabolaPy::staticCallback_getAxis (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ArcOfParabolaPy*)self)->getAxis());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ArcOfParabolaPy*)self)->setAxis(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ArcOfParabolaPy::staticCallback_getParabola (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ArcOfParabolaPy*)self)->getParabola());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject ArcOfParabolaPy::Parents[] = { PARENTSPartArcOfParabolaPy };
