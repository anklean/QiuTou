...
PyObject * PlanePy::staticCallback_uIso (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((PlanePy*)self)->uIso(args);
        if (ret != 0)
            ((PlanePy*)self)->startNotify();
        return ret;
    }
...
PyObject * PlanePy::staticCallback_vIso (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((PlanePy*)self)->vIso(args);
        if (ret != 0)
            ((PlanePy*)self)->startNotify();
        return ret;
    }
...
PyObject * PlanePy::staticCallback_getPosition (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((PlanePy*)self)->getPosition());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((PlanePy*)self)->setPosition(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * PlanePy::staticCallback_getAxis (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((PlanePy*)self)->getAxis());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((PlanePy*)self)->setAxis(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject PlanePy::Parents[] = { PARENTSPartPlanePy };
