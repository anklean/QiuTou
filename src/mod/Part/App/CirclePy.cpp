...
PyObject * CirclePy::staticCallback_getRadius (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((CirclePy*)self)->getRadius());
...
{    
    ...
    try {
        ((CirclePy*)self)->setRadius(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * CirclePy::staticCallback_getCenter (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((CirclePy*)self)->getCenter());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((CirclePy*)self)->setCenter(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * CirclePy::staticCallback_getAxis (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((CirclePy*)self)->getAxis());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((CirclePy*)self)->setAxis(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * CirclePy::staticCallback_getXAxis (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((CirclePy*)self)->getXAxis());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((CirclePy*)self)->setXAxis(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * CirclePy::staticCallback_getYAxis (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((CirclePy*)self)->getYAxis());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((CirclePy*)self)->setYAxis(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject CirclePy::Parents[] = { PARENTSPartCirclePy };
