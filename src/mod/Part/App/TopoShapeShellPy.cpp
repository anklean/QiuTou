...
PyObject * TopoShapeShellPy::staticCallback_add (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TopoShapeShellPy*)self)->add(args);
        if (ret != 0)
            ((TopoShapeShellPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TopoShapeShellPy::staticCallback_getFreeEdges (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TopoShapeShellPy*)self)->getFreeEdges(args);
        if (ret != 0)
            ((TopoShapeShellPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TopoShapeShellPy::staticCallback_getBadEdges (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TopoShapeShellPy*)self)->getBadEdges(args);
        if (ret != 0)
            ((TopoShapeShellPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TopoShapeShellPy::staticCallback_makeHalfSpace (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TopoShapeShellPy*)self)->makeHalfSpace(args);
        if (ret != 0)
            ((TopoShapeShellPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TopoShapeShellPy::staticCallback_getMass (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((TopoShapeShellPy*)self)->getMass());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * TopoShapeShellPy::staticCallback_getCenterOfMass (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((TopoShapeShellPy*)self)->getCenterOfMass());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * TopoShapeShellPy::staticCallback_getMatrixOfInertia (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((TopoShapeShellPy*)self)->getMatrixOfInertia());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * TopoShapeShellPy::staticCallback_getStaticMoments (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((TopoShapeShellPy*)self)->getStaticMoments());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * TopoShapeShellPy::staticCallback_getPrincipalProperties (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((TopoShapeShellPy*)self)->getPrincipalProperties());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject TopoShapeShellPy::Parents[] = { PARENTSPartTopoShapeShellPy };
