...
PyObject * SurfaceOfExtrusionPy::staticCallback_getDirection (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((SurfaceOfExtrusionPy*)self)->getDirection());
...
{    
    ...
    try {
        ((SurfaceOfExtrusionPy*)self)->setDirection(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * SurfaceOfExtrusionPy::staticCallback_getBasisCurve (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((SurfaceOfExtrusionPy*)self)->getBasisCurve());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((SurfaceOfExtrusionPy*)self)->setBasisCurve(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject SurfaceOfExtrusionPy::Parents[] = { PARENTSPartSurfaceOfExtrusionPy };
