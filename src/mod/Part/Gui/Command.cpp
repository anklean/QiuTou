...
//===========================================================================
// Part_CreateBallCutter
//===========================================================================
DEF_STD_CMD(CmdPartCreateBallCutter);

CmdPartCreateBallCutter::CmdPartCreateBallCutter()
:Command("Part_CreateBallCutter")
{
	sAppModule = "Part";
	sGroup = "Part";
	sMenuText = "Make path";
	sToolTipText = "Create an qiu tou fen qu";
	sWhatsThis = "Part_NewDoc";
	sStatusTip = sToolTipText;
	sPixmap = "qiutoufenqu";
}

void CmdPartCreateBallCutter::activated(int iMsg)
{
	QString cmd;
	cmd = qApp->translate("CmdPartCreateBallCutter", "BallCutter");
	openCommand((const char*)cmd.toUtf8());

	doCommand(Doc, "App.ActiveDocument.addObject(\"Part::BallCutter\",\"BallCutter\")");
	cmd = QString::fromAscii("App.ActiveDocument.ActiveObject.Label = \"%1\"")
		.arg(qApp->translate("CmdPartCreateBallCutter", "BallCutter"));
...
void CreatePartCommands(void)
{
	...
	rcCmdMgr.addCommand(new CmdPartCreateBallCutter());
} 
