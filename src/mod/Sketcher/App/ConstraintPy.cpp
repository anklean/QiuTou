...
// This File is normaly build as an include in ConstraintPyImp.cpp! Its not intended to be in a project!
...
PyObject * ConstraintPy::staticCallback_getFirst (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ConstraintPy*)self)->getFirst());
...
{    
    ...
    try {
        ((ConstraintPy*)self)->setFirst(Py::Int(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ConstraintPy::staticCallback_getSecond (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ConstraintPy*)self)->getSecond());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ConstraintPy*)self)->setSecond(Py::Int(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ConstraintPy::staticCallback_getName (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ConstraintPy*)self)->getName());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ConstraintPy*)self)->setName(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject ConstraintPy::Parents[] = { PARENTSSketcherConstraintPy };
...
ConstraintPy::~ConstraintPy()                                // Everything handled in parent
{
    ...
    ConstraintPy::PointerType ptr = reinterpret_cast<ConstraintPy::PointerType>(_pcTwinPointer);
    delete ptr;
}
...
//--------------------------------------------------------------------------
PyObject *ConstraintPy::_getattr(char *attr)				// __getattr__ function: note only need to handle new state
{
    try {
...
int ConstraintPy::_setattr(char *attr, PyObject *value) 	// __setattr__ function: note only need to handle new state
{
    try {
