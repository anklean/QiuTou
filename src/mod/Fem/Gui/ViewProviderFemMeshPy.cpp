...
PyObject * ViewProviderFemMeshPy::staticCallback_applyDisplacement (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((ViewProviderFemMeshPy*)self)->applyDisplacement(args);
        if (ret != 0)
            ((ViewProviderFemMeshPy*)self)->startNotify();
        return ret;
    }
...
PyObject * ViewProviderFemMeshPy::staticCallback_setNodeColorByScalars (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((ViewProviderFemMeshPy*)self)->setNodeColorByScalars(args);
        if (ret != 0)
            ((ViewProviderFemMeshPy*)self)->startNotify();
        return ret;
    }
...
PyObject * ViewProviderFemMeshPy::staticCallback_setNodeDisplacementByVectors (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((ViewProviderFemMeshPy*)self)->setNodeDisplacementByVectors(args);
        if (ret != 0)
            ((ViewProviderFemMeshPy*)self)->startNotify();
        return ret;
    }
...
PyObject * ViewProviderFemMeshPy::staticCallback_getNodeColor (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ViewProviderFemMeshPy*)self)->getNodeColor());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ViewProviderFemMeshPy*)self)->setNodeColor(Py::Dict(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ViewProviderFemMeshPy::staticCallback_getElementColor (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ViewProviderFemMeshPy*)self)->getElementColor());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ViewProviderFemMeshPy*)self)->setElementColor(Py::Dict(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ViewProviderFemMeshPy::staticCallback_getNodeDisplacement (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ViewProviderFemMeshPy*)self)->getNodeDisplacement());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ViewProviderFemMeshPy*)self)->setNodeDisplacement(Py::Dict(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ViewProviderFemMeshPy::staticCallback_getHighlightedNodes (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ViewProviderFemMeshPy*)self)->getHighlightedNodes());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ViewProviderFemMeshPy*)self)->setHighlightedNodes(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ViewProviderFemMeshPy::staticCallback_getVisibleElementFaces (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ViewProviderFemMeshPy*)self)->getVisibleElementFaces());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject ViewProviderFemMeshPy::Parents[] = { PARENTSFemGuiViewProviderFemMeshPy };

//--------------------------------------------------------------------------
// Constructor
//--------------------------------------------------------------------------
ViewProviderFemMeshPy::ViewProviderFemMeshPy(ViewProviderFemMesh *pcObject, PyTypeObject *T)
    : ViewProviderPy(reinterpret_cast<ViewProviderPy::PointerType>(pcObject), T)
{
}
