...
PyObject * ToolPy::staticCallback_copy (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((ToolPy*)self)->copy(args);
        if (ret != 0)
            ((ToolPy*)self)->startNotify();
        return ret;
    }
...
PyObject * ToolPy::staticCallback_getName (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getName());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setName(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ToolPy::staticCallback_getToolType (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getToolType());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setToolType(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ToolPy::staticCallback_getMaterial (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getMaterial());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setMaterial(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ToolPy::staticCallback_getDiameter (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getDiameter());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setDiameter(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ToolPy::staticCallback_getLengthOffset (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getLengthOffset());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setLengthOffset(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ToolPy::staticCallback_getFlatRadius (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getFlatRadius());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setFlatRadius(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ToolPy::staticCallback_getCornerRadius (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getCornerRadius());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setCornerRadius(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ToolPy::staticCallback_getCuttingEdgeAngle (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getCuttingEdgeAngle());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setCuttingEdgeAngle(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ToolPy::staticCallback_getCuttingEdgeHeight (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ToolPy*)self)->getCuttingEdgeHeight());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ToolPy*)self)->setCuttingEdgeHeight(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject ToolPy::Parents[] = { PARENTSPathToolPy };
...
ToolPy::~ToolPy()                                // Everything handled in parent
{
    ...
    ToolPy::PointerType ptr = reinterpret_cast<ToolPy::PointerType>(_pcTwinPointer);
    delete ptr;
}
