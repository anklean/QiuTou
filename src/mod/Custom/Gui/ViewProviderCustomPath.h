#ifndef CUSTOMGUI_VIEWPROVIDERCUSTOMPATH_H
#define CUSTOMGUI_VIEWPROVIDERCUSTOMPATH_H
...
class CustomGuiExport ViewProviderCustomPath : public PartGui::ViewProviderPart
{
	PROPERTY_HEADER(CustomGui::ViewProviderCustomPath);

public:
    /// constructor
	ViewProviderCustomPath();
    /// destructor
	virtual ~ViewProviderCustomPath();
