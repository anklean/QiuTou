...
PROPERTY_SOURCE(CustomGui::ViewProviderCustomPath, PartGui::ViewProviderPart)


ViewProviderCustomPath::ViewProviderCustomPath()
{
...
void ViewProviderCustomPath::onChanged(const App::Property* prop)
{
	if (prop == &LineColor) {
...
void CustomGui::ViewProviderCustomPath::attach(App::DocumentObject *pcFeat)
{
...
void CustomGui::ViewProviderCustomPath::updateData(const App::Property* prop)
{
...
void CustomGui::ViewProviderCustomPath::updateVisual(const TopoDS_Shape & prop)
{
// 	Custom::PathObject* pPathObj = dynamic_cast<Custom::PathObject*>(pcObject);
// 	Custom::PathObject::PathPointList ptList = pPathObj->getPointList();
// 
// 	const int size = ptList.size();
// 
// 	SbVec3f* verts = new SbVec3f[size];
// 	int32_t* lines = new int32_t[size + 1];
// 
// 	for (int i = 0; i < size; i++)
// 	{
// 		Base::Vector3d pt = ptList[i].Point;
// 		SbVec3f ttt(pt.x, pt.y, pt.z);
// 		verts[i] = ttt;
// 		lines[i] = i;
// 	}
// 
// 	lines[size] = -1;
// 
// 	pCoords->point.setNum(size);
// 	pCoords->point.setValues(0, size, verts);
// 
// 	lineset->coordIndex.setNum(size + 1);
// 	lineset->coordIndex.setValues(0, size + 1, lines);
// 
// 
// 	delete verts;
// 	delete lines;
...
void CustomGui::ViewProviderCustomPath::StartCutter()
{	
	if (player==0)
...
void CustomGui::ViewProviderCustomPath::stopCutter()
{
	if (player != 0)
	{
		player->Stop();
