...
PyObject * FacetPy::staticCallback_unbound (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((FacetPy*)self)->unbound(args);
        if (ret != 0)
            ((FacetPy*)self)->startNotify();
        return ret;
    }
...
PyObject * FacetPy::staticCallback_intersect (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((FacetPy*)self)->intersect(args);
        if (ret != 0)
            ((FacetPy*)self)->startNotify();
        return ret;
    }
...
PyObject * FacetPy::staticCallback_getIndex (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((FacetPy*)self)->getIndex());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * FacetPy::staticCallback_getBound (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((FacetPy*)self)->getBound());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * FacetPy::staticCallback_getNormal (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((FacetPy*)self)->getNormal());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * FacetPy::staticCallback_getPoints (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((FacetPy*)self)->getPoints());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * FacetPy::staticCallback_getPointIndices (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((FacetPy*)self)->getPointIndices());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * FacetPy::staticCallback_getNeighbourIndices (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((FacetPy*)self)->getNeighbourIndices());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject FacetPy::Parents[] = { PARENTSMeshFacetPy };
...
FacetPy::~FacetPy()                                // Everything handled in parent
{
    ...
    FacetPy::PointerType ptr = reinterpret_cast<FacetPy::PointerType>(_pcTwinPointer);
    delete ptr;
}
