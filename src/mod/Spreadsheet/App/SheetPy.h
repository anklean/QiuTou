...
public:
    ...
    /// callback for the setPosition() method
    static PyObject * staticCallback_setPosition (PyObject *self, PyObject *args);
    /// implementer for the setPosition() method
    PyObject*  setPosition(PyObject *args);
    //@}
...
#define PARENTSSpreadsheetSheetPy &SheetPy::Type,PARENTSAppDocumentObjectPy
