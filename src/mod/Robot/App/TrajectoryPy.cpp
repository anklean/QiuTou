...
PyObject * TrajectoryPy::staticCallback_insertWaypoints (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TrajectoryPy*)self)->insertWaypoints(args);
        if (ret != 0)
            ((TrajectoryPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TrajectoryPy::staticCallback_position (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TrajectoryPy*)self)->position(args);
        if (ret != 0)
            ((TrajectoryPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TrajectoryPy::staticCallback_velocity (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TrajectoryPy*)self)->velocity(args);
        if (ret != 0)
            ((TrajectoryPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TrajectoryPy::staticCallback_deleteLast (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((TrajectoryPy*)self)->deleteLast(args);
        if (ret != 0)
            ((TrajectoryPy*)self)->startNotify();
        return ret;
    }
...
PyObject * TrajectoryPy::staticCallback_getDuration (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((TrajectoryPy*)self)->getDuration());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * TrajectoryPy::staticCallback_getLength (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((TrajectoryPy*)self)->getLength());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * TrajectoryPy::staticCallback_getWaypoints (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((TrajectoryPy*)self)->getWaypoints());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((TrajectoryPy*)self)->setWaypoints(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject TrajectoryPy::Parents[] = { PARENTSRobotTrajectoryPy };
...
TrajectoryPy::~TrajectoryPy()                                // Everything handled in parent
{
    ...
    TrajectoryPy::PointerType ptr = reinterpret_cast<TrajectoryPy::PointerType>(_pcTwinPointer);
    delete ptr;
}
