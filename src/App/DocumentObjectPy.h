...
public:
    ...
    /// callback for the lock() method
    static PyObject * staticCallback_lock (PyObject *self, PyObject *args);
    /// implementer for the lock() method
    PyObject*  lock(PyObject *args);
    /// callback for the unlock() method
    static PyObject * staticCallback_unlock (PyObject *self, PyObject *args);
    /// implementer for the unlock() method
    PyObject*  unlock(PyObject *args);
