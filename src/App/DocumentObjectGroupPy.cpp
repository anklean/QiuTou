...
PyObject * DocumentObjectGroupPy::staticCallback_newObject (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectGroupPy*)self)->newObject(args);
        if (ret != 0)
            ((DocumentObjectGroupPy*)self)->startNotify();
        return ret;
    }
...
PyObject * DocumentObjectGroupPy::staticCallback_addObject (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectGroupPy*)self)->addObject(args);
        if (ret != 0)
            ((DocumentObjectGroupPy*)self)->startNotify();
        return ret;
    }
...
PyObject * DocumentObjectGroupPy::staticCallback_removeObject (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectGroupPy*)self)->removeObject(args);
        if (ret != 0)
            ((DocumentObjectGroupPy*)self)->startNotify();
        return ret;
    }
...
PyObject * DocumentObjectGroupPy::staticCallback_removeObjectsFromDocument (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectGroupPy*)self)->removeObjectsFromDocument(args);
        if (ret != 0)
            ((DocumentObjectGroupPy*)self)->startNotify();
        return ret;
    }
...
PyObject * DocumentObjectGroupPy::staticCallback_getObject (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectGroupPy*)self)->getObject(args);
        if (ret != 0)
            ((DocumentObjectGroupPy*)self)->startNotify();
        return ret;
    }
...
PyObject * DocumentObjectGroupPy::staticCallback_hasObject (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectGroupPy*)self)->hasObject(args);
        if (ret != 0)
            ((DocumentObjectGroupPy*)self)->startNotify();
        return ret;
    }
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject DocumentObjectGroupPy::Parents[] = { PARENTSAppDocumentObjectGroupPy };
