...
PyObject * ComplexGeoDataPy::staticCallback_getBoundBox (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ComplexGeoDataPy*)self)->getBoundBox());
...
PyObject * ComplexGeoDataPy::staticCallback_getPlacement (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ComplexGeoDataPy*)self)->getPlacement());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ComplexGeoDataPy*)self)->setPlacement(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
PyObject * ComplexGeoDataPy::staticCallback_getMatrix (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ComplexGeoDataPy*)self)->getMatrix());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
{    
    ...
    try {
        ((ComplexGeoDataPy*)self)->setMatrix(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject ComplexGeoDataPy::Parents[] = { PARENTSDataComplexGeoDataPy };
