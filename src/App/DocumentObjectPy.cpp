...
PyMethodDef DocumentObjectPy::Methods[] = {
    ...
    {"lock",
        (PyCFunction) staticCallback_lock,
        METH_VARARGS,
        "lock the object to changed"
    },
    {"unlock",
        (PyCFunction) staticCallback_unlock,
        METH_VARARGS,
        "unlock the object to changed"
    },
    {"recompute",
...
// lock() callback and implementer
// PyObject*  DocumentObjectPy::lock(PyObject *args){};
// has to be implemented in DocumentObjectPyImp.cpp
PyObject * DocumentObjectPy::staticCallback_lock (PyObject *self, PyObject *args)
{
    // test if twin object not allready deleted
    if (!((PyObjectBase*) self)->isValid()){
        PyErr_SetString(PyExc_ReferenceError, "This object is already deleted most likely through closing a document. This reference is no longer valid!");
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectPy*)self)->lock(args);
        if (ret != 0)
            ((DocumentObjectPy*)self)->startNotify();
        return ret;
    }
...
// unlock() callback and implementer
// PyObject*  DocumentObjectPy::unlock(PyObject *args){};
// has to be implemented in DocumentObjectPyImp.cpp
PyObject * DocumentObjectPy::staticCallback_unlock (PyObject *self, PyObject *args)
{
    // test if twin object not allready deleted
    if (!((PyObjectBase*) self)->isValid()){
        PyErr_SetString(PyExc_ReferenceError, "This object is already deleted most likely through closing a document. This reference is no longer valid!");
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectPy*)self)->unlock(args);
        if (ret != 0)
            ((DocumentObjectPy*)self)->startNotify();
        return ret;
    }
...
PyObject * DocumentObjectPy::staticCallback_recompute (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((DocumentObjectPy*)self)->recompute(args);
        if (ret != 0)
            ((DocumentObjectPy*)self)->startNotify();
        return ret;
    }
