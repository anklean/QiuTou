...
PyObject * MaterialPy::staticCallback_set (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((MaterialPy*)self)->set(args);
        if (ret != 0)
            ((MaterialPy*)self)->startNotify();
        return ret;
    }
...
{    
    ...
    try {
        ((MaterialPy*)self)->setShininess(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
{    
    ...
    try {
        ((MaterialPy*)self)->setTransparency(Py::Float(PyNumber_Float(value),true));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject MaterialPy::Parents[] = { PARENTSAppMaterialPy };
...
MaterialPy::~MaterialPy()                                // Everything handled in parent
{
    ...
    MaterialPy::PointerType ptr = reinterpret_cast<MaterialPy::PointerType>(_pcTwinPointer);
    delete ptr;
}
