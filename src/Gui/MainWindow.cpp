  ...
  : QMainWindow( parent, f/*WDestructiveClose*/ )
{
	...
	// Task view
	TaskView::TaskView* pcTaskView = new TaskView::TaskView(this);
	pcTaskView->setObjectName(QString::fromAscii(QT_TRANSLATE_NOOP("QDockWidget","Task View")));
	pcTaskView->setMinimumWidth(150);
	pDockMgr->registerDockWindow("Std_TaskView", pcTaskView);
