...
PyObject * WorkbenchPy::staticCallback_name (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((WorkbenchPy*)self)->name(args);
        if (ret != 0)
            ((WorkbenchPy*)self)->startNotify();
        return ret;
    }
...
PyObject * WorkbenchPy::staticCallback_activate (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((WorkbenchPy*)self)->activate(args);
        if (ret != 0)
            ((WorkbenchPy*)self)->startNotify();
        return ret;
    }
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject WorkbenchPy::Parents[] = { PARENTSGuiWorkbenchPy };
