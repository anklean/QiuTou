...
PyObject * ViewProviderDocumentObjectPy::staticCallback_update (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((ViewProviderDocumentObjectPy*)self)->update(args);
        if (ret != 0)
            ((ViewProviderDocumentObjectPy*)self)->startNotify();
        return ret;
    }
...
PyObject * ViewProviderDocumentObjectPy::staticCallback_getObject (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((ViewProviderDocumentObjectPy*)self)->getObject());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
// Parents structure
//--------------------------------------------------------------------------
PyParentObject ViewProviderDocumentObjectPy::Parents[] = { PARENTSGuiViewProviderDocumentObjectPy };
