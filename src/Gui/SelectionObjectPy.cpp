...
PyObject * SelectionObjectPy::staticCallback_isObjectTypeOf (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = ((SelectionObjectPy*)self)->isObjectTypeOf(args);
        if (ret != 0)
            ((SelectionObjectPy*)self)->startNotify();
        return ret;
    }
...
PyObject * SelectionObjectPy::staticCallback_getTypeName (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((SelectionObjectPy*)self)->getTypeName());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
...
PyObject * SelectionObjectPy::staticCallback_getPickedPoints (PyObject *self, void * /*closure*/)
{
    ...
    try {
        return Py::new_reference_to(((SelectionObjectPy*)self)->getPickedPoints());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return NULL;
    } catch (...) {
